...
export function GitHubButton({ href, label, className = "" }: GitHubButtonProps) {
  return (
    <a
      href={href}
      target="_blank"
      rel="noreferrer"
      className={`group inline-flex items-center gap-3 rounded-full bg-foreground px-6 py-3 text-sm font-semibold text-background shadow-lg shadow-black/20 transition-all hover:-translate-y-1 hover:bg-primary hover:text-primary-foreground hover:shadow-primary/20 ${className}`}
    >
